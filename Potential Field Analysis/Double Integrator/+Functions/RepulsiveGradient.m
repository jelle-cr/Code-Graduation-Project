function grad_U_rep = RepulsiveGradient(q_i, q_j, n, K_rep, rho_0, r_a, r_o, a_max)
    p_i = q_i(1:2);
    v_i = q_i(3:4);
    p_j = q_j(1:2);
    v_j = q_j(3:4);
    ...
    if rho - rho_m < rho_0
        if v_r_ij > 0
            ...
            grad_U_rep_p = -grad_U_rep_base*(v_r_ij/a_max*(v_ij/p_ij_norm - (p_ij*p_ij.'*v_ij)/p_ij_norm^3) - p_ij_hat);
